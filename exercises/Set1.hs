...
power n k = power' 1 n k
power' :: Integer -> Integer -> Integer -> Integer
power' a n 0 = a
power' a n k = power' (a * n) (n) (k - 1)
...
ilog3 n = ilog3' 3 0 0 n
ilog3' :: Integer -> Integer ->Integer -> Integer -> Integer
ilog3' d b k 0 = b
ilog3' divisor kount answer n = ilog3' (3) (kount + 1) (n) (n `div` divisor)
